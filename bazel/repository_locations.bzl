...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_bufbuild_buf = dict(
        project_name = "Buf CLI",
        project_desc = "A new way of working with Protocol Buffers",
        project_url = "https://github.com/bufbuild/buf",
        version = "1.56.0",
    ...
    envoy_toolshed = dict(
        ...
        version = "0.3.3",
        sha256 = "7c9f89e7e6c4ec28a3d6de60e0eb8a9d6a0e51c31d6f6e7f9c6e5c5f5c5e5c5e",  # Placeholder - needs actual SHA
